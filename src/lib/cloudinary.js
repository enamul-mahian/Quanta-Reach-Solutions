// =========================================================================
// Quanta Reach Solutions - Secure Cloudinary Client-Side Media Uploader
// =========================================================================
import { env, isCloudinaryConfigured } from '/src/lib/env.js';
// মিডিয়া টাইপ ও ফাইলের সাইজ লিমিটেশন (কোয়ান্টা রিচ এজেন্সির রুলস অনুযায়ী)
const FILE_LIMITS = {
    image: {
...
export const uploadToCloudinary = async (file, onProgress) => {
    if (!isCloudinaryConfigured()) {
        throw new Error('Cloudinary setup is incomplete. Please define Cloudinary variables in your .env file.');
    }
