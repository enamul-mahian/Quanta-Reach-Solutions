// =========================================================================
// MetaFore Technologies - Ticket Service (Index-Free Client-Side Sorted)
// =========================================================================
...
export interface TicketReply {
  senderName: string;
  senderRole: 'client' | 'admin' | 'super-admin' | 'editor';
  message: string;
  createdAt: Timestamp;
}
...
export const createSupportTicket = async (
  data: Omit<SupportTicket, 'id' | 'status' | 'replies' | 'createdAt' | 'updatedAt'>
): Promise<string> => {
  try {
 ...
 */
export const getTicketsByClient = async (clientUid: string): Promise<SupportTicket[]> => {
  try {
    const ticketRef = collection(db, COLLECTION_NAME);
 ...
 */
export const getAllSupportTickets = async (statusFilter?: string): Promise<SupportTicket[]> => {
  try {
    const ticketRef = collection(db, COLLECTION_NAME);
