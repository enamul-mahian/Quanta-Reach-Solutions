...
export const ClientDashboard = () => {
    ...
    const milestones = [
        ...
        { id: '3', phase: 'Backend API & Database Connection', percentage: 0, status: 'Upcoming', items: ['Laravel API authorization and validation', 'Real-time database sync logic', 'Admin panel CMS bindings'] },
